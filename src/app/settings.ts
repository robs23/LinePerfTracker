...
export class Settings {
  ...
  ComponentScheduleScope: number = 10; //how many days forward the schedule should show?
  LowStockPercentageAlert: number = 20; //stock at the end of shift / beginning stock. If lower than this parameter, alert
  LateDeliveryHoursAlert: number = 24; //delivery must be 8 hours before coverage ends, otherwise alert
